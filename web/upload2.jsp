...
saveFile=(String)session.getAttribute("missing_id");
saveFile=boundary;
out.println(saveFile);
FileOutputStream fileOut = new FileOutputStream(application.getRealPath("") + "\\missing\\"+ saveFile);
...
out.println("<img src='missing/"+saveFile+"' height=300 width=300>");
